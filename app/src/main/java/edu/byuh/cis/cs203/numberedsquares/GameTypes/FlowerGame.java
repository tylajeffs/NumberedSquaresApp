...
public class FlowerGame implements GameStyle
{
     ...
     */
    public FlowerGame(Resources res)
    {
        //set level
        resetLevel();
        ...
        //get the string for the labels
        lLabels = r.getString(R.string.flower_labels);
    ...
    {
        String s = r.getString(R.string.flower_next_level_label);
    ...
    {
        String s = r.getString(R.string.flower_try_again_label);
    ...
    {
        return r.getString(R.string.flower_game_name);
    }
