...
public class PlantGame implements GameStyle
{
     ...
     */
    public PlantGame(Resources res)
    {
        //set level
        resetLevel();
        ...
        lLabels = r.getString(R.string.plant_labels);
    ...
    {
        //get the string
        String s = r.getString(R.string.plant_next_level_label);
    ...
    {
        //get the string
        String s = r.getString(R.string.plant_try_again_label);
    ...
    {
        return r.getString(R.string.plant_game_name);
    }
